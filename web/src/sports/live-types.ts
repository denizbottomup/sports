...
export interface User { id: string; email: string; name: string; picture: string | null; favorite: UserTeam | null; followed: UserTeam[]; }
...
export interface Reading { title: string; paragraphs: string[]; kind: 'brief' | 'excerpt'; language: string; checkedAt: string; }
