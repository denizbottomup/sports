...
export interface LiveNews { reading?: Reading; linkOnly?: boolean; id: string; title: string; summary: string; url: string; image: string | null; imageSource: string | null; publishedAt: string | null; datePrecision: string; firstSeenAt: string; teamId: string; sourceId: string; source: string; official: boolean; language: string; category: string; }
